...
<body>
  <div class="title-box">21 Hari Lagi Kak Thania Theresia Podung Ulang Tahun! 🎉🎂🥳</div>
  ...
  <div id="photo-gallery" class="photo-gallery" style="display: none;">
    <div class="gallery-container">
      <img src="foto 8.jpeg" class="gallery-photo">
    </div>
  </div>

  <script>
    const audio = new Audio('Seventeen- Holiday.mp3');
    ...
    const fullMessage = `Langit tak selalu cerah, namun tetap ada pelangi yang menanti 🤍. Seperti hidup, terkadang kita melewati awan gelap, tetapi yakinlah, keindahan akan selalu ada setelahnya🌈. Mungkin kita tidak bisa memilih cuaca, tetapi kita bisa memilih untuk tetap tersenyum di tengah hujan 🌻..`;
